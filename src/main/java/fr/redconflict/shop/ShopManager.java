...
import fr.redconflict.ring.RingEffects;
import fr.redconflict.shop.ShopDatabase.ShopCategory;
...
public class ShopManager {
    ...
    private long effBuy(Player player, ShopItem it) {
        long base = effBuy(it);
        if (fr.redconflict.ring.RingEffects.hasRing(player, RingEffects.NECKLACE_OF_MERCHANT)) {
    ...
    private long effSell(Player player, ShopItem it) {
        ...
        if (fr.redconflict.ring.RingEffects.hasRing(player, fr.redconflict.ring.RingEffects.NECKLACE_OF_MERCHANT)) {
